                ...
                <div className="col-md-8 mx-auto rounded border p-4">
                    ...
                    <div className="row mb-3">
                            ...
                            <div className="col-sm-8">
                                <input readOnly className="form-control-paintext" defaultValue={params.id}/>
                            </div>
                        </div>
                    {
                        initialData &&
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-8">
                                    <input readOnly className="form-control-plaintext" defaultValue={initialData.slice(0, 10)}  />
